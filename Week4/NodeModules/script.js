function output() {
    const thirdStr = process.argv[2];
    const url = require("url");
    const querystring = require("querystring");

    // const myUrl = "http://127.0.0.1:8080/test?a=100&b=200";
...
/////
// 1. Get the third string typed on the command line
// (the item in process.argv at index 2)

// 2. require the url module

// 3. pass the value obtained in step 1 to the url module's parse method

// 4. log properties from the object returned by the url modules parse method
...
// Additionally, if there is query string in the url,
// it should log the value of each parameter.
//////////
...
// both of which have a parse method
// that accepts a string as a parameter
// and returns an object.
// (The parse method of the url module is described as a legacy API. It is not deprecated, however, and you can feel free to use it.)
